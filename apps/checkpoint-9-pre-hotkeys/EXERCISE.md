...
- The header's Search button opens the palette and already shows a `⌘K`
  hint, which does nothing yet. That's yours.
...
3. Add the Hotkeys devtools plugin in `src/routes/__root.tsx`.
