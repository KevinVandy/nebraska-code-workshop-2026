...
/* Only genuinely SHARED queries live in this file — each is used by more than
 * one call site, and those call sites must agree on the query key. Fetches
...
/** Shared options for one page of the Book tab's table. */
